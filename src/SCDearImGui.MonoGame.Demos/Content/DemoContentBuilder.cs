...
public class DemoContentBuilder : ContentBuilder
{
    public DemoContentBuilder()
    {
    ...
    // This is a build logger that is identical to the default,
    // except that it outputs to Trace rather than the Console.
    private class TraceBuildLogger : ContentBuildLogger
    {
